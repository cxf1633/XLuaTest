...
-- local NativeService = require("NativeService")
-- local FullQuadBlit = require("Rendering.FullQuadBlit")
...
-- SM.RegisterService(SM.SERVICE_TYPE.FULL_QUAD_BLIT, FullQuadBlit)
