...
---@alias AnimatorControllerLoadCallback fun(controllerRef: CS.Extend.Asset.AssetReference):void
---@alias AnimationClipLoadCallback fun(clipRef: CS.Extend.Asset.AssetReference):void
---@alias TextLoadCallback fun(textRef: CS.Extend.Asset.AssetReference):void
---@alias PrefabLoadCallback fun(controller: CS.UnityEngine.GameObject):void
---@alias ScriptableObjectLoadCallback fun(controller: CS.UnityEngine.ScriptableObject):void
