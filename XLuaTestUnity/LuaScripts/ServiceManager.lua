...
function M.GetNativeService()
	return services[M.SERVICE_TYPE.NATIVE]
end

---@return Game.State.GameIsland.NpcService
function M.GetNpcService()
	return services[M.SERVICE_TYPE.NPC]
end
