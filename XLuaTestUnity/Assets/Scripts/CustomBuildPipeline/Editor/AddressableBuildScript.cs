...
namespace CustomBuildPipeline.Editor
{
	...
	{
		public static string buildScriptPath = "Assets/AddressableAssetsData/DataBuilders/BuildScriptPackedMode.asset";

		public static string settingsPath = "Assets/AddressableAssetsData/AddressableAssetSettings.asset";

		public static string contentBinPath = "Assets/AddressableAssetsData/";
		...
		public static void BuildAddressables(bool isBase, string contentPath)
		{
			...
			else
			{
				...
				bundleDupeDependenciesRule.GroupName = "RemoteDynamicSplit";
		...
		[MenuItem("Tools/Build/更新aa包")]
		public static void BuildUpdateAddressables()
		{
			BuildAddressables( false, "");
		}

		[MenuItem("Tools/Build/清理aa缓存")]
