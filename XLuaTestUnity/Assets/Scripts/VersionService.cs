...
namespace CC
{
	...
	public class VersionService
	{
		...
		public VersionService()
		{
			...
			ResUrl = "https://xiaoicemedia.blob.core.chinacloudapi.cn/island";
			isBeginner = false;
		}
...
// 			}
		...
		public void StartLua()
		{
			...
			// using (var assetRef = AssetService.Get().Load<GameObject>("Audio/Wwise.prefab"))
			// {
			// 	_wwiseGO = assetRef.Instantiate();
			// 	assetRef.Dispose();
			// }
			...
			if (Application.isMobilePlatform)
			{
				...
				var renderScale = Mathf.Min(1.0f, maxVerticalPixelCount /
				                                  (float)(Screen.orientation == ScreenOrientation.Landscape
					                                  ? Screen.height
					                                  : Screen.width));
			...
			_isClean = false;
			//
			// NativeManager.DispatchOnLuaReady();
		}
		...
		public void Clear()
		{
			if (!_isClean)
			{
				...
				// UnityEngine.Object.DestroyImmediate(AudioUtilities.GlobalAudioObj);
				_isClean = true;
			}
		}
