...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class ForwardLights
    {
        static class LightConstantBuffer
        {
            ...
            public static int _MainLightCookieTex;
        ...
        public ForwardLights()
        {
            ...
            LightConstantBuffer._MainLightCookieTex = Shader.PropertyToID("_MainLightCookieTexture");
        ...
        private void GetLightUVScaleOffset(UniversalAdditionalLightData additionalLightData, ref Matrix4x4 uvTransform)
        {
        ...
        void SetupMainLightConstants(CommandBuffer cmd, ref LightData lightData)
        {
            ...
            if( mainLight.light.cookie ) {
                Matrix4x4 cookieUVTransform = Matrix4x4.identity;
                if( mainLight.light.TryGetComponent(out UniversalAdditionalLightData additionalLightData) ) {
                    GetLightUVScaleOffset(additionalLightData, ref cookieUVTransform);
                }

                cmd.SetGlobalTexture(LightConstantBuffer._MainLightCookieTex, mainLight.light.cookie);

                Matrix4x4 cookieMatrix = s_DirLightProj * cookieUVTransform *
                                         mainLight.localToWorldMatrix.inverse;
                cmd.SetGlobalMatrix(LightConstantBuffer._MainLightWorldToLight, cookieMatrix);
                CoreUtils.SetKeyword(cmd, ShaderKeywordStrings.LightCookies, true);
            }
            else {
                CoreUtils.SetKeyword(cmd, ShaderKeywordStrings.LightCookies, false);
            }
