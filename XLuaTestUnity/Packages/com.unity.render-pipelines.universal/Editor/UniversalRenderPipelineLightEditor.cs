...
#pragma warning restore 618
        ...
        private SerializedProperty _cookieSize;
        private SerializedProperty _cookieOffset;
        ...
        void init(UniversalAdditionalLightData additionalLightData)
        {
            ...
            _cookieSize = m_AdditionalLightDataSO.FindProperty("m_LightCookieSize");
            _cookieOffset = m_AdditionalLightDataSO.FindProperty("m_LightCookieOffset");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if( settings.cookie ) {
                EditorGUILayout.PropertyField(_cookieSize);
                EditorGUILayout.PropertyField(_cookieOffset);
