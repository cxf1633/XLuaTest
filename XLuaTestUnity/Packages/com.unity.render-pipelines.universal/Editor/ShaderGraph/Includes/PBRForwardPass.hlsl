...
//#include "Packages/com.unity.render-pipelines.universal/Shaders/Fog/AzureFogCore.cginc"
...
half4 frag(PackedVaryings packedInput) : SV_TARGET
{
    ...
    //color.rgb = ApplyAzureFog(color, inputData.positionWS);
    //color.rgb = MixFog(color.rgb, inputData.fogCoord);
    color.rgb = lerp(color.rgb, unpacked.fogFactorAndVertexLight.rgb, unpacked.fogFactorAndVertexLight.a);
    return color;
}
