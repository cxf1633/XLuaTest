...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    ...
    sealed class UniversalTarget : Target, ILegacyTarget
    {
        ...
        [SerializeField]
        private bool m_CustomZWrite = false;

        [SerializeField]
        private bool m_CustomCull = false;
        ...
        public bool customZWrite {
            get => m_CustomZWrite;
            set => m_CustomZWrite = value;
        }

        public bool customCull {
            get => m_CustomCull;
            set => m_CustomCull = value;
        }
...
#region RenderStates
    static class CoreRenderStates
    {
        public static readonly RenderStateCollection Default = new RenderStateCollection
        {
            ...
            { RenderState.ZWrite(ZWrite.On), new [] {new FieldCondition(UniversalFields.SurfaceOpaque, true), new FieldCondition(UniversalFields.ZWriteCustom, false)} },
            { RenderState.ZWrite(ZWrite.Off), new [] {new FieldCondition(UniversalFields.SurfaceTransparent, true), new FieldCondition(UniversalFields.ZWriteCustom, false)} },
            { RenderState.ZWrite("[_ZWrite]"), new FieldCondition(UniversalFields.ZWriteCustom, true) },
            { RenderState.Cull(Cull.Back), new [] {new FieldCondition(Fields.DoubleSided, false), new FieldCondition(UniversalFields.CullCustom, false)} },
            { RenderState.Cull(Cull.Off), new [] {new FieldCondition(Fields.DoubleSided, true), new FieldCondition(UniversalFields.CullCustom, false)} },
            { RenderState.Cull("[_Cull]"), new FieldCondition(UniversalFields.CullCustom, true) },
            { RenderState.Blend(Blend.One, Blend.Zero), new [] { new FieldCondition(UniversalFields.SurfaceOpaque, true), new FieldCondition(UniversalFields.BlendCustom, false) } },
            ...
            { RenderState.Blend("[_SrcBlend]", "[_DstBlend]"), new FieldCondition(UniversalFields.BlendCustom, true) },
        };
