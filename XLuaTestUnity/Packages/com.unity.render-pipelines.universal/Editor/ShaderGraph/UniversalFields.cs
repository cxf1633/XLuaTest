...
#region Fields
        ...
        public static FieldDescriptor BlendCustom =           new FieldDescriptor(kBlendMode,   "Custom",                 "_BLENDMODE_ALPHA 1");

        public static FieldDescriptor ZWriteCustom =          new FieldDescriptor(string.Empty,   "ZWriteCustom",                 "");
        public static FieldDescriptor CullCustom =            new FieldDescriptor(string.Empty,   "CullCustom",                 "");
